...
@rem set MSDeployPath="L:\Program Files (x86)\IIS\Microsoft Web Deploy V2\"
@rem ---------------------------------------------------------------------------------
...
set _DeploySetParametersFile=%RootPath%losttie.SetParameters.xml
)
...
@rem ---------------------------------------------------------------------------------
if not exist "%RootPath%losttie.zip" (
echo "%RootPath%losttie.zip" does not exist. 
...
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%losttie.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%losttie.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension %_MsDeployAdditionalFlags%
) else (
echo. "%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%losttie.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%losttie.SetParameters.xml" %_MsDeployAdditionalFlags%
"%MSDeployPath%\msdeploy.exe" -source:package='%RootPath%losttie.zip' -dest:%_Destination% -verb:sync -disableLink:AppPoolExtension -disableLink:ContentExtension -disableLink:CertificateExtension -setParamFile:"%RootPath%losttie.SetParameters.xml" %_MsDeployAdditionalFlags%
)
goto :eof
...
:usage
echo =========================================================
if not exist "%RootPath%losttie.deploy-readme.txt" (
...
start notepad "%RootPath%losttie.deploy-readme.txt"
)
echo =========================================================
goto :eof
